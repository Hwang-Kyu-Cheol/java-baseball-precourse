...
class OutputTest {
    ...
    void Ball3() {
        BallStrike result = new BallStrike(3, 0, false);
    ...
    void Ball1_Strike2() {
        BallStrike result = new BallStrike(1, 2, false);
    ...
    void Strike3() {
        BallStrike result = new BallStrike(0, 3, true);
    ...
    void Ball0_Strike0() {
        BallStrike result = new BallStrike(0, 0, false);
